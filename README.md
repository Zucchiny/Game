...
* **Map Popularity** — статистика использования игровых карт.
* **Game Stats DB** — детальная таблица накопленной статистики по игрокам.
* **Event Types Distribution** — соотношение убийств, смертей, достижений и других действий.
